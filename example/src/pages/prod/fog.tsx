...
const Control = () => {
  return (
    <OrbitControls enableZoom={true} enableDamping={true} rotateSpeed={0.3} dampingFactor={1} />
  )
}

const rotation = [-0.4239391588266323, 0.7010640463834621, 0.2832774959276831] as any
